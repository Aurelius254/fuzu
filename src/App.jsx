      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#0f1720]/90 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-300">
            <a href="#" className="hidden md:inline hover:text-white transition">Courses</a>
            <a href="#" className="hidden md:inline hover:text-white transition">Pricing</a>
            <button type="button" className="bg-white text-black px-5 py-2 rounded-full text-sm font-semibold hover:scale-105 transition-transform">
              Sign in
            </button>
          </div>
        </div>
